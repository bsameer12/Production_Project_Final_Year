...
def load_model():
    model = tf.keras.models.load_model('asl_sign_language_resnet_model_using_ResNet50.h5')  # Load the entire model
    return model

# Load class labels for predictions
def load_class_labels():
    with open('class_labels_resnet.pkl', 'rb') as f:
...
test_image_path = '../ASL(American_Sign_Language)_Alphabet_Dataset/ASL_Alphabet_Dataset/asl_alphabet_test/A/A_test.jpg'  # Replace with your test image path
